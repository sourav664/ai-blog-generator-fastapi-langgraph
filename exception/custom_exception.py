...
class BlogGeneratorException(Exception):
    ...
    def __repr__(self):
        return f"BlogGeneratorException(file={self.file_name!r}, line={self.lineno}, message={self.error_message!r})"
...
if __name__ == "__main__":
    ...
    try:
        ...
        raise BlogGeneratorException("Division failed", e) from e
